...
public class UploadedMemberProfileImageService {
    ...
    public  UploadedMemberProfileImageService(
    ...
    public ImageUrlResponseDto uploadProfileImage(MultipartFile file) {
        ...
        //DB 저장
        uploadedImageRepository.save(UploadedImage.create(fileName,imageUrl, ImagePurpose.PROFILE));
    ...
    public UploadedImage findDefaultProfileImage() {
        return uploadedImageRepository.findDefaultMemberProfileImage(DefaultStatus.DEFAULT,ImagePurpose.PROFILE).orElseThrow(() -> new ImageCustomException(ErrorMessage.NOT_FOUND_FILE));
    }
